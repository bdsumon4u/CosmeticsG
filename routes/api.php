...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('classified/related-products/{slug}', 'App\Http\Controllers\Api\V2\CustomerProductController@relatedProducts');
    Route::get('classified/product-details/{slug}', 'App\Http\Controllers\Api\V2\CustomerProductController@productDetails');
